...
const Search = () => {
  const { apiKey, setApiKey, searchPrograms, searchResults, isLoading } = usePerplexityContext();
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Search for academic programs using Perplexity AI
        </p>
      </div>
      ...
      {!apiKey ? (
        <Card>
          <CardHeader>
            <CardTitle>Connect your Perplexity API Key</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="mb-4 text-sm text-muted-foreground">
              To search for programs, you need to provide your Perplexity API key. This key will be stored in your browser for this session only.
            </p>
